...
export function RollControls({
  ...
  return (
    <div className="mx-auto my-5.5 flex w-full max-w-[760px] flex-wrap items-center justify-center gap-3 px-4 min-[900px]:my-2.5 min-[900px]:gap-2 max-[640px]:m-0 max-[640px]:gap-2 max-[640px]:border-t max-[640px]:border-edge max-[640px]:bg-bg-1 max-[640px]:px-3 max-[640px]:pt-2.5 max-[640px]:pb-[calc(10px+env(safe-area-inset-bottom))]">
      <div className="flex w-full items-center justify-between gap-2.5 rounded-xl border border-edge bg-bg-2 px-3 py-2 min-h-11">
      ...
      <div className="flex w-full flex-1 flex-wrap items-stretch gap-2">
        <button
          ...
          className="flex flex-[0_1_auto] min-w-0 items-center justify-center gap-1.5 rounded-xl border border-gold bg-gold/12 px-3.5 py-2 text-[0.92rem] font-bold tracking-wide whitespace-nowrap text-gold-bright transition-[background,transform] hover:not-disabled:bg-gold/22 active:not-disabled:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40 max-[640px]:min-h-11 max-[640px]:flex-1 max-[640px]:text-[0.95rem]"
        >
          🎲 Hodit
        </button>
