...
export function DiceTray({
  ...
  return (
    <div className="grid w-full max-w-[760px] grid-cols-3 gap-2 min-[641px]:flex min-[641px]:flex-wrap min-[641px]:justify-center min-[641px]:gap-4.5 min-[900px]:max-w-[380px] min-[900px]:gap-2">
      {DICE.map((die) => {
        ...
        const displayValue = isRollingParticipant
          ...
          : rolling
            ...
            : settled.value;
        return (
          <div key={die.name} className="min-[641px]:flex-[0_0_140px] min-[900px]:flex-[0_0_118px]">
            <DieTile
              die={die}
              qty={pool[die.name] ?? 0}
