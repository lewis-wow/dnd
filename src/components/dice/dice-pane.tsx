...
export const DicePane = forwardRef<HTMLElement, DicePaneProps>(function DicePane(
  ...
  return (
    <section
      ...
      className="flex min-w-0 flex-col min-[900px]:h-full min-[900px]:flex-none min-[900px]:basis-110 min-[900px]:overflow-y-auto"
    >
      ...
      <main className="flex w-full flex-1 flex-col items-center gap-1.5 overflow-hidden px-3 py-1 max-[640px]:justify-center min-[641px]:flex-none min-[641px]:overflow-visible min-[641px]:px-4 min-[641px]:py-1.5">
